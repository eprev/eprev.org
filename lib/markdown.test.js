...
describe(`markdown`, it => {
  ...
  describe(`inline attributes`, it => {
    it('treat <!--: --> comments as attributes for the previous inline tag', assert => {
      assert.deepEqual(parse('_text_<!--: key="value" -->'), [
        { type: 'paragraph_start' },
        { type: 'em_start', key: 'value' },
        { type: 'text', value: 'text' },
        { type: 'em_end' },
        { type: 'paragraph_end' },
      ]);
  ...
  describe(`block attributes`, it => {
    it(`treat <!--: --> comments as attributes for the previous block tag`, assert => {
      ...
      assert.deepEqual(parse('```\nfoo();\n```\n<!--: key="value" -->'), [
        { type: 'block_code', lang: '', value: 'foo();', key: 'value' },
      ]);
    });
